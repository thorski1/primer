...
PRIMER_PACKS = [
    ...
    "logic", "shapes", "sports", "simple_machines", "reading", "writing", "cultures", "health", "basic_math", "electricity", "plants", "insects", "astronomy", "robotics", "countries", "brain", "python_kids",
]
